 ...
 */
class MoviesAdapterML(dataList: List<out Any>, context: Context?) : RecyclerView.Adapter<MoviesAdapterML.MyViewHolder>() {
    ...
    override fun onBindViewHolder(holder: MoviesAdapterML.MyViewHolder, position: Int) {
        try {
...
//                }
                ...
                LogUtil.d("MOVIELISTING", "Data type not know")
            }
