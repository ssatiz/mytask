...
public class EventCinemaFragment : Fragment() {
    lateinit var mcontext: Context
    lateinit var tvNomovie : TextView

    companion object {
        lateinit var eventCinemaItem: List<EventCinema>
        fun newInstance(resp: List<EventCinema>) = EventCinemaFragment().apply {
    ...
    override fun onCreateView(inflater: LayoutInflater, container: ViewGroup?, savedInstanceState: Bundle?): View? {
        ...
        try {
            ...
            val mAdapter = MoviesAdapter(eventCinemaItem, mcontext)
