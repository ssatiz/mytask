 ...
 */
public class NowShowingFragmentML : Fragment() {
    ...
    companion object {
        ...
        fun newInstance(resp: List<NowShowing>) = NowShowingFragmentML().apply {
            nowShowingItem = resp
        }
    ...
    private lateinit var mAdapter: MoviesAdapterML
    override fun onCreateView(inflater: LayoutInflater, container: ViewGroup?,
        ...
        try {
            if (nowShowingItem.size > 0) {
                ...
                mAdapter = MoviesAdapterML(nowShowingItem, mcontext)
