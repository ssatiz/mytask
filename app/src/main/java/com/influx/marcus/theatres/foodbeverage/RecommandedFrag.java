...
public class RecommandedFrag extends Fragment {
    ...
    public RecommandedFrag(ArrayList<FoodModel> cinemafilter) {
...
*/
        RecommandedAdapter adapter = new RecommandedAdapter(getActivity(), arrCinemaFilter);
    ...
    public class RecommandedAdapter extends RecyclerView.Adapter<RecommandedAdapter.ViewHolder> {
        ...
        public RecommandedAdapter(Context context, ArrayList<FoodModel> filtermodel) {
            this.arrLocFilter = filtermodel;
            this.mcontext = context;
        }

        @Override
        public RecommandedAdapter.ViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        ...
        public void onBindViewHolder(final ViewHolder holder, int position) {
            try {
                ...
                holder.tvLocName.setText(foodModel.getFoodName());
                //todo make sure picasso image url is not empty/null
